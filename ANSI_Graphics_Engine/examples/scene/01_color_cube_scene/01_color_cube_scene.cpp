...
namespace Example
{
	...
	bool ColorCubeScene::Initialize()
	{
		...
		//m_cube->GetTransform()->SetScale(5.0f, 5.0f, 5.0f);
		m_cube->GetTransform()->SetScale(1.0f, 1.0f, 1.0f);
		...
		camera->SetSize(AN::Core::GetWindow()->GetWidth(), AN::Core::GetWindow()->GetHeight());
	...
	bool ColorCubeScene::OnUpdate()
	{
		//m_cube->GetTransform()->AddRotationY(20.0f * AN::Core::GetTimer()->GetDeltaTime());
